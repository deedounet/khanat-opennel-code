...
//XP
	 //
	 // -	On garde les points de d�g�ts inflig�s sur chaque cr�ature par chaque team ou joueur sans team (consid�r� comme une team de 1)
	 //
	 // -	la � team � avec le plus de d�g�ts est la seule a gagner l�xp de la cr�ature
	 //
	 // -	Tout joueur membre d�une team ayant fait une action �de combat� a moins de X m�tres de la cr�ature tu�e par son groupe gagne sa part
	 // d�Xp, qu�il soit ou non dans l�aggro list de la cr�ature. L�Xp est r�parti �quitablement entre les joueurs �ligibles.
	 // Chaque cr�ature a une valeur d�XP fixe renseign�e dans sa fiche. Cette valeur est multipli�e par le facteur d�Xp obtenu par l��cart
	 // de niveau entre la cr�ature (XpLevel) et la plus forte skill utilis�e par n�importe quel membre du groupe (magie ou combat, soins compris).
	 // Chaque team a un � poids � �gal a 1 + 0.8 par membre au d�l� de 1 (cette valeur de 0.8 est r�glable dans le cfg de l�egs)
	 // Une fois le total d�Xp calcul� on divise par le � poids � de la team et on donne a chacun sa part.
	 //
	 //  NB : Si un joueur �ligible se trouve a plus de Y m�tres de la cr�ature ET qu�il n�est plus dans l�aggro list au moment de la mort de
	 //	 celle-ci il ne gagne pas sa part mais il compte dans la division !!
	 //
	 //	 -	Si un joueur rejoint une team il �fusionne� ses d�g�ts avec celle-ci.
	 //
	 //	 -	Si un joueur quitte une team il �emm�ne� une partie des d�g�ts sur chaque cr�ature pour laquelle il aurait pu gagner de l�XP.
	 //	 Cette partie est tout simplement le total des d�g�ts de la team divis� par le nb de membres avant son d�part.
	 //
	 //	 -	Si tous les membres de la team sortent de l�aggro list d�une cr�ature leurs degats sur celle-ci sont transf�r�s sur le compte d'une
	 //	 cr�ature fictive. Par exemple on a 2 joueurs sans team, l�un fait 99% des degats et meurt et respawn, ses 99% sont transf�r�s � une
	 //	 cr�ature fictive. Le 2�me joueur ach�ve la cr�ature, il a fait 1% des degats, la cr�ature fictive a fait le plus de d�gats et donc aucun
	 //	 joueur r�el ne gagne d�XP.
	 //
	 //	 - ATTENTION : les gardes et autres npcs sont aussi comptabilis�s pour leur degats, et n�ont pas de �range� de validit� (par contre
	 //	 ils doivent etre ds l�aggro liste ??). Ce qui veut dire que si une cr�ature est gravement bless�e par un garde le joueur qui l�ach�ve
	 //	 ne gagne rien.
	 //
