...
extern NLMISC::CVariable<float>					HitChestChaScore2LossFactor;
...
extern NLMISC::CVariable<float>					ForageChaScore1RatioPerSourceLifeImpact;
...
extern NLMISC::CVariable<sint32>				ForageChaScore4RatioOfLocateDeposit;
